...
?>
    ...
    <div class="container d-flex justify-content-between">
        <a href="manage_offenses"  class="text-dark"><u>&larr; Go Back</u></a>
        <div class="d-flex justify-content-between">
            <p class="btn btn-primary" id="open-modal-btn">Add Offense <i class="fa fa-info-circle fa-fade fa-beat"></i></p>&nbsp;
            <!-- <p><a href="view_all_offense.php" class="btn btn-primary">Go to All Offense <i class="fa-fade fa-beat">&rarr;</i></a></p>&nbsp; -->
    ...
    <div class="table-container" style="width: 90%; margin: 20px auto;">
       <?php
        include '../backend/manage_all_offense.php';
       ?>
    </div>
            ...
            <form action="" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <select name="offense_type" class="form-select" id="bT" require>
                        ...
                        <option value="bookDamage">Book Damage</option>
                        <option value="bookLost">Book Lost</option>
                    </select>
                ...
                <div class="mb-3">
                    <label for="password" class="form-label">Fines Amount:</label>
                    <input type="number" class="form-control" id="pYear" name="fines" maxlength="4" placeholder="Enter Publication Year" required>
                </div>
